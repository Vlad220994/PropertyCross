...
const MyLocation = (props) => {
  const { watch, settings, city } = props;

  const { latitude, longitude, timestamp, accuracy, error }:any = usePosition(watch, settings);
  ...
  const onSearchByCoords = () => {
    props.searchCityByCoordinates(centerLatValue, centerLongValue);
  };
